/**
 * File: FAnyFeatNonBin.h
 * Date: March 2024
 * Original Author: Dorian Galvez-Lopez
 * Modified by Alejandro Fontan Villacampa for AnyFeature-VSLAM
 * Description: functions for AnyFeatNonBin descriptors
 * License: see the LICENSE.txt file
 *
 */
  
#ifndef __D_T_F_ANYFEATNONBIN__
#define __D_T_F_ANYFEATNONBIN__
...
/// Functions to manipulate AnyFeatNonBin descriptors
class FAnyFeatNonBin: protected FClass
{
public:
